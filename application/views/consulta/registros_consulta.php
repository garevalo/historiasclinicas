                                   ...
                                   <table class="table table-bordered table-condensed table-striped table-hover" id="tabla">
                                        ...
                                        <tbody>
                                                ...
                                                <tr class="text-center" ondblclick ="">
                                                    <td><?php
                                                        if($rowcitas->idestado_cita!= 1){
                                                           echo anchor(site_url("historias/cconsulta/form_consulta/".$rowcitas->idcitas),"<span class='label label-lg label-success'>".$rowcitas->idcitas."</span>",'');
                                                        }
                                                        else {
                                                        echo  "<span class='label label-lg label-success'>".$rowcitas->idcitas."</span>";
                                                        }
                                                        ?>
                                                    </td>
