...
<h2 align="center" class="title">Citas Registradas </h2>
...
<tr class="cabecera">
    ...
    <th align="center" width="25%">Fecha y Hora</th>
    <th align="center" width="15%">Especialidad</th>
</tr>
';
...
$html.='<tr>
        ...
        <td align="center">'.$rowcitas->nombres.' '.$rowcitas->apepaterno.' '.$rowcitas->apematerno.'</td>
        <td align="center">'.$rowcitas->dni.'</td>         
        <td align="center">'.$rowcitas->inicio.'</td> 
        <td align="center">'.$rowcitas->nombre_personal.'</td>
        </tr>';    
